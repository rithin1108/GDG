...
const FileUploadComponent = () => {
    ...
    const handleFileChange = (event) => {
        ...
        console.log(event.target.files[0]); // Log selected file
    };
    ...
    return (
      <Box sx={{ p: 3, borderRadius: "12px", backgroundColor: "#fff", "&:hover": { backgroundColor: "#e5ecfc",border: "2px solid rgba(0, 0, 0, 0.1)",  } }}>
            ...
            <StyledPaper>
              <DataGrid
                ...
                sx={{
                  ...
                  "& .MuiDataGrid-row:hover": { backgroundColor: "#e5ecfc" },
                }}
              />
            </StyledPaper>
          </Box>
